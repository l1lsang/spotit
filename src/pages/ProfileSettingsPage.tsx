...
import { ArrowLeft, BookOpen, Camera, Check, ChevronRight, Crop, Lock, LogOut, Save, Trash2, UserMinus, X } from 'lucide-react'
...
export function ProfileSettingsPage() {
  ...
  return (
    <PageContainer className="content-page profile-page profile-settings-page">
      <Link className="person-profile-back" to="/profile"><ArrowLeft size={18} aria-hidden="true" />내 프로필</Link>
